...
export class Dochub1741934278852 implements MigrationInterface {
  name = 'Dochub1741934278852';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "pinned_docs_hub" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "userId" integer, "docsHubId" uuid, CONSTRAINT "PK_06c95c7df59e08be2735a3d9704" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
