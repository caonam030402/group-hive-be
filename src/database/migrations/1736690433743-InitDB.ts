...
export class InitDB1736690433743 implements MigrationInterface {
  name = 'InitDB1736690433743';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `ALTER TABLE "chats" ADD "avatar" character varying`,
    );
  ...
  public async down(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(`ALTER TABLE "chats" DROP COLUMN "avatar"`);
  }
}
